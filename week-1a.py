...
class Player:
    ...
    def play(self, dealerCard):
        ...
        self.dealerCard = random.randint(0,9)
        ...
        if playerCard < dealerCard:
            ...
            return "player " + str[inputID] + " Lose, " + str[playerCard] + " vs. " + str[dealerCard]
            startingPot = initialPot - 1

        else:
            # [INCREMENT THE PLAYER'S POT, AND RETURN A MESSAGE]
            return "player " + str[inputID] + " Win, " + str[playerCard] + " vs. " + str[dealerCard]
            startingPot = initialPot + 1
